...
- 2026-04-20 — Item 22: authored skipped planted-bug tests. Backend (tests/RecipeHub.Api.Tests/Bugs/): BugCookModeOffByOneTests (3), BugSearchCaseSensitivityTests (3), BugSharePersistenceTests (2) over a temp-file SQLite RecipeApiFactory reusing Program.cs Migrate+Seed. Frontend: useCookMode.bug.test.tsx (2 it.skip, BUG-001). Added public partial class Program; to Program.cs. Build 0/0; dotnet test 0 failed / 9 skipped; npm run test 0 failed / 3 skipped; lint clean. Bugs remain planted.
