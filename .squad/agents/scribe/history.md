...
- **2026-04-20:** Merged 8 inbox decision files (2 copilot directives, 2 plan pointers, 4 item outcomes) into canonical `.squad/decisions.md`. Cleared inbox. Created orchestration.md with spawn log and coordination notes. Updated identity/now.md focus from "Items 1-4 scaffolding" to "Items 5-9 batch: seed data, CRUD, UI components". Team workflow: decision merge + orchestration log + inbox sweep after every substantial batch of agent spawns.
